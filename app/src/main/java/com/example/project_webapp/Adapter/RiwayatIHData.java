...
public class RiwayatIHData {
    ...
    public RiwayatIHData(String id_pembayaran, String id_cluster, String nama_pemesan, String nama_cluster, String status, String tgl, String bukti){
